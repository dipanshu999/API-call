...
export default function Navbar({darkMode, setMode}) {

 
  return (
    <div><nav className={`p-4 text-xl flex px-10  ${darkMode ? 'bg-[#9484ff96] text-black' : 'bg-black text-white'} justify-between ` } >
