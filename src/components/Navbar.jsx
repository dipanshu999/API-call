...
export default function Navbar() {
  ...
  return (
    <div><nav className={`p-4 text-xl flex px-10  ${darkMode ? 'bg-[#9484ff] text-black' : 'bg-black text-white'} justify-between ` } >
       ...
       <div className="ToggleBox flex gap-3">
          <div className=" DAY h-8 w-8 contrast-200 saturate-200"><img src= {day} alt="" /></div>
             <label className="inline-flex items-center cursor-pointer border-white  rounded-full">
                 <input type="checkbox" value="" className="sr-only peer" onClick={()=>setDarkMode((prev)=>!prev)} />
